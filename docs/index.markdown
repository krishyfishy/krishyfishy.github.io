...
Thank you so much for visiting my website. If you want to know more about my background, chect out the [work page](https://krishmaypole.com/work). You can also download a copy of my resume [here]({{ site.url }}/docs/Krish_Maypole_Resume.pdf). If you want to get in touch, [let's chat](mailto:krish.maypole@yale.edu)!